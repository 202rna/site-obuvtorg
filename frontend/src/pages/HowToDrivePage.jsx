  ...
  return (
    <div style={styles.container}>
      ...
      <h1 style={styles.title}>
        ООО Фирма «Обувьторг» — Схема проезда / Покупки товара
      </h1>
      ...
      <div style={styles.section}>
        ...
        <p>
          <strong>🕒 Режим работы:</strong> Вт. – Пт. 09:00–17:00, Сб.
          09:00–16:00 | Вс. – Пн. выходной
        </p>
        <p>
      ...
      <div style={styles.section}>
        ...
        <p>
          Мы находимся внутри оптово-производственной базы «Обувьторг» на улице
          Вспольинское Поле, 18.
        </p>
        <ul style={{ paddingLeft: "20px", marginTop: "8px" }}>
          <li style={{ marginBottom: "8px" }}>
            ...
            заезжаете в ворота базы. Наш магазин находится в глубине территории,
            около него предусмотрена открытая парковка для клиентов.
          </li>
          <li>
            <strong>На общественном транспорте:</strong> Автобусы №49 / №17 до
            остановки «Асфальтовый завод». Пеший путь от остановки через
            промзону займет около 8 минут спокойным шагом.
          </li>
        </ul>
      </div>
    </div>
